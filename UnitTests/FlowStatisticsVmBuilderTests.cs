		...
		public void Init()
		{
			...
			executionsList.Add(
				new Execution
				{
					...
					ExecutionDefects = "ONESCREEN-11608,ONESCREEN-11979 | ONESCREEN-11979",
			...
			executionsList.Add(
				new Execution
				{
					...
					ExecutedStatus = ExecutedStatus.Pass,
					ExecutionDefects = "ONESCREEN-11788 | ONESCREEN-11788",
			...
			executionsList.Add(
				new Execution
				{
					...
					ExecutionDefects = "ONESCREEN-12481",
			...
			executionsList.Add(
				new Execution
				{
					...
					ExecutionDefects = "ONESCREEN-11770,ONESCREEN-11608 | ONESCREEN-11770,ONESCREEN-11608",
			...
			executionsList.Add(
				new Execution
				{
					...
					ExecutionDefects = "ONESCREEN-11779,ONESCREEN-12058,ONESCREEN-12481 | ONESCREEN-11779,ONESCREEN-12058",
